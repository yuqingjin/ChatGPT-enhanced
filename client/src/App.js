    ...
    <div className="App">
      ...
      <section className="chatbox">
        <div className="chat-log">
          {/* use the item index as its key like the following: */}
        ...
        <div className="chat-input-holder">
          <form onSubmit={handleSubmit}>
            {/* using input can submit by 'Enter' KEY*/}
            <input
              name='input'
...
// use '{message}' instead of 'message' since chatMessage has two props: key and message
const ChatMessage = ({message})=> {
  return (
    // if message.user === 'gpt', then className includes 'chatgpt'
